...
function visaKundkorg() { // Denna funktionen printar endast ut listan med objekt i localStorage
	if (CheckBrowser()) {
		...
		for (var i = 0; i <= localStorage.length-1; i++) {
            ...
            // produktNamn	
            list += "<tr style='margin-bottom: 40px;' class='card h-100'><td class='fw-bolder' style='padding-right: 50px; font-size: 30px; padding-left: 15px;' id='produktNamn" + i + "'>" + produktNamn + "</td>\n"
            ...
            list += "<td style='font-size: 20px; font-weight: bold; text-align: right; padding-right: 15px' id='produktPris " + i + "'>" +
			parseInt(produktPris).toLocaleString("fr") + " kr" +"</td>";

            // produktAntal
            list += "<td style='font-size : 20px; font-weight: bold; text-align: right; padding-right: 15px' id='produktAntal" + i + "'>Antal: " +
			produktAntal + "</td>";
		...
		// Summeringsruta
		summering += "<tr class='card h-100'>" + "<td style='padding-left: 10px; padding-top: 10px;'><li type='button' class='btn btn-outline-dark mt-auto' onclick=rensaKundKorg()><a>Töm kundvagn</a></li></td>" + "<td class='fw-bolder' style='font-size: 30px; padding-left: 30px; padding-right: 30px; padding-bottom: 10px; text-align: center;'>"
		+ "Sammanställning" + "</td>";
		...
		summering += "<td style='text-align: left; padding-bottom: 50px; padding-left: 20px; text-align: center;'><a style='font-size: 25px;' href='Checkout.html' class='btn btn-outline-dark mt-auto'>Gå till checkout</a></td>" + "</tr>";
